...
SECOND_PERSON_PATTERNS = [
    re.compile(r"\b(you\s*(should|must|ought\s*to|can|could|need\s*to))\b", re.I),
    re.compile(r"\b(take\s+\d+|drink\s+\d+|consume\s+\d+|apply\s+\d+)\b", re.I),
    re.compile(r"\b(i\s*recommend|i\s*prescribe|prescribed\s*for\s*you)\b", re.I),
    re.compile(r"\b(your\s*(condition|symptoms|disease|treatment|dose))\b", re.I),
]
