...
class VerseRecord(BaseModel):
    verse_id: str = Field(
        ..., description="Unique ID: <book>_<sthana>_<chapter>_<verse>, e.g. cs_su_01_015"
    )
    ...
    sanskrit_devanagari: str | None = Field(None, description="Devanagari script if available")
    ...
    prev_verse_id: str | None = Field(
        None, description="Previous verse ID for context window expansion"
    )
    next_verse_id: str | None = Field(
        None, description="Next verse ID for context window expansion"
    )
